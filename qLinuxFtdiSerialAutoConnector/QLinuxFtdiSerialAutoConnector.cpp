/*
 * QLinuxFtdiSerialAutoConnector.cpp
 *
 *  Created on: 03.12.2011
 *      Author: cyborg-x1
 */

#include "QLinuxFtdiSerialAutoConnector.h"
#include <libudev.h>
...
namespace qFtdi
{
	QLinuxFtdiSerialAutoConnector::QLinuxFtdiSerialAutoConnector(QString vid, QString pid, QString serial, QString manufacturer,QString product, unsigned int retryseconds)
	{
	...
	QLinuxFtdiSerialAutoConnector::~QLinuxFtdiSerialAutoConnector()
	{
		quit();
		wait();
	}

	void QLinuxFtdiSerialAutoConnector::run()
	{
		QTimer timer1;
	...
	void QLinuxFtdiSerialAutoConnector::ifaceManagement()
	{
		if(searchSerial())
		{
	...
	bool QLinuxFtdiSerialAutoConnector::searchSerial()
	{
